...
main(int, char* argv[]) {
    ...
    unsigned int vertexShader = compileShader("Aufgaben/basic_colors.vert", GL_VERTEX_SHADER);
    unsigned int fragmentShader = compileShader("Aufgaben/basic_colors.frag", GL_FRAGMENT_SHADER);
