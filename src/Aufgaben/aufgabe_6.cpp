...
main(int, char* argv[]) {
    ...
    int cylindrical_loc = glGetUniformLocation(shaderProgram, "cylindrical");
    ...
    while (glfwWindowShouldClose(window) == false) {
        ...
        ImGui::Checkbox("Cylindrical", &cylindrical);
        ImGui::End();
        ...
        glUniform1i(cylindrical_loc, static_cast<int>(cylindrical));
