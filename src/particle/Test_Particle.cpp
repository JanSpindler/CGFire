...
main(int, char* argv[]) {
    ...
    particleProps.ColorBegin = { 254 / 255.0f, 0 / 255.0f, 0 / 255.0f, 1.0f };
    particleProps.ColorEnd = { 0 / 255.0f, 1 / 255.0f, 0 / 255.0f, 0.2f };
    particleProps.SizeBegin = 6.f;
    ...
    while (glfwWindowShouldClose(window) == false) {
        ...
        //particleProps.Position = moon.positions[0];
        particleSystem.OnUpdate(difference);
        particleSystem.OnRender(cam);
        if (emitTimer > 0.1f) {
        ...
        ImGui::SliderFloat3("Velocity", &particleProps.Velocity.x, 0, 10);
