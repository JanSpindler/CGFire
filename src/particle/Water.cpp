...
namespace particle{
            ...
            : m_ParticleSystem(particleSystem)
    {
        ...
        m_BaseWaterJetProps.VelocityVariation = { 0.0f, 0.0f, 0.0f };
        m_BaseWaterJetProps.GravityFactor = 1.f;
        m_BaseWaterJetProps.ColorBegin = { 0 / 255.0f, 0 / 255.0f, 255 / 255.0f, 1.0f };
        m_BaseWaterJetProps.ColorEnd = { 0 / 255.0f, 0 / 255.0f, 255 / 255.0f, 1.0f };
        m_BaseWaterJetProps.SizeBegin = 1.f;
        m_BaseWaterJetProps.SizeVariation = 0.9f;
        m_BaseWaterJetProps.SizeEnd = 1.0f;
    ...
    void WaterCreator::onUpdate(float ts){
        ...
        for (auto& waterJet : m_WaterJets) {
            ...
            const float FREQUENCY = 1.f / waterJet->ParticlesPerSecond;
            if (waterJet->SecondsSinceEmit > FREQUENCY)
            {
                ...
                for (size_t i = 0; i < numParticlesToEmit; ++i) {
                    ...
                    props.Velocity = waterJet->StartGradient + dTime * props.GravityFactor * glm::vec3(0.f, -9.81f, 0.f);
                ...
                waterJet->SecondsSinceEmit -= numParticlesToEmit * FREQUENCY; // do not set to 0, because save the rest time
            }
