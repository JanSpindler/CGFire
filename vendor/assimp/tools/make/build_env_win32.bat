...
set MSBUILD_15="C:\GLProgram Files (x86)\Microsoft Visual Studio\2018\Professional\MSBuild\15.0\Bin\msbuild.exe"
set MSBUILD_14="C:\GLProgram Files (x86)\MSBuild\14.0\Bin\msbuild.exe"
...
set PATH_VSWHERE=C:\GLProgram Files (x86)\Microsoft Visual Studio\Installer\
REM set PATH_STUDIO="C:\GLProgram Files (x86)\Microsoft Visual Studio\2017\Professional\"
